...
#  s.resources		    = "LLDebugToolSwift/**/*.{xib,storyboard,bundle}"
  s.dependency            "LLDebugTool" , '1.2.2'
  s.swift_version	= "4.0"

  s.subspec 'Network' do |ss|
    ss.dependency                 "LLDebugTool/Network" , '1.2.2'
  end

  s.subspec 'Log' do |ss|
    ss.source_files             = "LLDebugToolSwift/**/*.{h,m,swift}"
    ss.dependency                 "LLDebugTool/Log" , '1.2.2'
  end

  s.subspec 'Crash' do |ss|
    ss.dependency                 "LLDebugTool/Crash" , '1.2.2'
  end

  s.subspec 'AppInfo' do |ss|
    ss.dependency                 "LLDebugTool/AppInfo" , '1.2.2'
  end

  s.subspec 'Sandbox' do |ss|
    ss.dependency                 "LLDebugTool/Sandbox" , '1.2.2'
  end

  s.subspec 'Screenshot' do |ss|
    ss.dependency                 "LLDebugTool/Screenshot" , '1.2.2'
  end

  s.subspec 'StorageManager' do |ss|
    ss.dependency                 "LLDebugTool/StorageManager" , '1.2.2'
  end

  s.subspec 'General' do |ss|
    ss.dependency                 "LLDebugTool/General" , '1.2.2'
  end
